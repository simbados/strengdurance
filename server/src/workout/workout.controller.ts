...
export class WorkoutController {
  ...
  async getStrengthWorkoutsInTimeFrame(@Request() req, @Param() params): Promise<StrengthWorkout[]> {
    return this.strengthWorkoutService.getStrengthWorkoutsInTimeFrame(req.user.userId, params.startDate, params.endDate);
  }

  @Post('strength')
  async createStrengthWorkout(@Request() req, @Body() strengthWorkoutDto: StrengthWorkoutDto): Promise<StrengthWorkout> {
    return this.strengthWorkoutService.createStrengthWorkout(req.user.userId, strengthWorkoutDto);
  }
}
